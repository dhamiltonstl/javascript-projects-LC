...
let idxOfCAT = dnaTwo.indexOf("CAT")
if (idxOfCAT) console.log("CAT gene found")
else console.log("CAT gene NOT found")
//3) Use .slice() to print out the fifth gene (set of 3 characters) from the DNA strand.
console.log(dnaTwo.split("-")[4])
//4) Use a template literal to print, "The DNA strand is ___ characters long."
console.log(`The DNA strand is ${dnaTwo.length} characters long.`)
//5) Just for fun, apply methods to ``dna`` and use another template literal to print, 'taco cat'.
console.log(`taco ${dna.slice(dna.toLowerCase().indexOf("cat"), 44).toLowerCase()}`)