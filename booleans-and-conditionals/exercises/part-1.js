...
if (crewStatus == true) console.log("Crew Ready")
...
if (fuelLevel < 1000 || engineTemperature > 2500 || engineIndicatorLight == "red blinking") console.log("ENGINE FAILURE IMMINENT!")
...
if (fuelLevel > 20000 && engineIndicatorLight !== "red blinking" || commandOverride) console.log("Cleared to launch!")
